...
Protected attribute name starts with an underscore `_`
Private attribute name starts with a double underscore `__`
...
#    - Chronione: `email`, `phone`
#    - Prywatne: `username`, `password`

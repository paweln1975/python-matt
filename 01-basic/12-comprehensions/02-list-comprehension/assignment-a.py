...
# 60% of first features in `DATA`
# type: list[tuple]
features_train = [feature[:-1] for feature in rows[:split]]

# 40% of last features in `DATA`
# type: list[tuple]
features_test = [feature[:-1] for feature in rows[split:]]

# 60% of first labels in `DATA`
# type: list[str]
labels_train = [name[-1] for name in rows[:split]]

# 40% of last labels in `DATA`
# type: list[str]
labels_test = [name[-1] for name in rows[split:]]

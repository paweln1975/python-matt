"""
* Assignment: Re Findall Date
* Complexity: easy
* Lines of code: 2 lines
* Time: 5 min

English:
    1. Define `result: list[str]` with dates in US long format:
       example: 'October 4, 1957', 'April 12, 1961', 'May 5, 1961'
    2. Run doctests - all must succeed

Polish:
    1. Zdefiniuj `result: list[str]` z datami w formacie US long:
       przykład: 'October 4, 1957', 'April 12, 1961', 'May 5, 1961'
...
DATA = """In the late 1950s and early 1960s, the United States was engaged in

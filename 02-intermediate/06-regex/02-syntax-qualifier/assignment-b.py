...
English:
    1. Define `result: str` with regular expression to find:
        a. all lowercase and uppercase letters
        b. all lowercase and uppercase letters and digits
    2. Run doctests - all must succeed

Polish:
    1. Zdefiniuj `result: str` z wyrażeniem regularnym aby wyszukać:
        a. wszystkie małe i duże litery
        b. wszystkie małe i duże litery oraz wszystkie cyfry

...
English:
    ...
    4. Define `result: dict` with values:
        a. at 2000-02-29,
        b. first value in the series (use `.iloc[]`),
        c. last value in the series (use `.iloc[]`),
...
Tests:
    ...
    {'2000-02-29': np.float64(-0.3627411659871381),
     'first': np.float64(1.764052345967664),
     'last': np.float64(0.40198936344470165),
     'middle': np.float64(-0.8954665611936756)}
"""
